...
import NetworkChangePopUp from '../sharedComponents/networkChangePopUp'
...
const NftCard: React.FC<Props> = ({
  ...
  async function getUserLikeOrDislike() {
    if (bitverseAlchemy) {
      if (userAddress) {
        ...
        // console.log("nftCard component")
        // console.log("User hasn't linked the account yet")
      }
    } else {
      console.error('contract not found: NFT-Page \ngetUserLikeOrDislike fn')
    }
  }
  ...
  return (
    <div className="div">
      ...
      {networkChangePopup && <div className="absolute inset-0"> <NetworkChangePopUp setNetworkChangePopUp={setNetworkChangePopUp} /></div>}
